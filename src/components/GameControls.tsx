  ...
  return (
    <div className="flex items-center gap-2 min-h-[36px]">
      ...
      <button
        ...
        aria-label={`Game speed: ${gameSpeed}x. Click to cycle speed`}
      ...
      <span className="relative group">
        ...
        <span id="shortcuts-tooltip" role="tooltip" className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden group-hover:block group-focus-within:block bg-gray-800 text-gray-300 text-xs rounded px-3 py-2 whitespace-nowrap z-20 border border-gray-600">
